...
按提示输入：
- **机器人名称**（显示名称）：例如 `Crazytra Trading Bot`
- **机器人用户名**（必须以 bot 结尾）：例如 `crazytra_trading_bot`
...
You will find it at t.me/crazytra_trading_bot
...
# 检查 Redis 连接
docker exec -it crazytra-redis redis-cli ping
```
